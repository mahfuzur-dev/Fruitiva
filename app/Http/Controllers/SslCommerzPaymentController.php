...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $request->total_pay; # You cant not pay less than 10
    ...
    public function success(Request $request)
    {
        ...
        $order_id = Order::insertGetId([
            ...
            'total'=>$data['subtotal']- $data['discount']+$data['delivary'],
        ...
        $amount = $data['sub_otal']- $data['discount']+$data['delivary'];
